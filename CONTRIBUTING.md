...
This repository accepts small, public-facing improvements to OpenMonitor
notebooks, readers, schemas, and documentation.

Good contributions:

- Fix a notebook cell that no longer runs.
- Improve an export reader.
- Add a small sample file.
